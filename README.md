...
This repository contains the data to testify machine-generated detection methods described in our paper, [MAGE: Machine-generated Text Detection in the Wild](https://arxiv.org/abs/2305.13242). 
...
We consider four new datasets: CNN/DailyMail, DialogSum, PubMedQA and IMDb to test the detection of machine-generated news, dialogues, scientific answers and movie reviews.
We sample 200 instances from each dataset and use a newly developed LLM, i.e., GPT-4, with specially designed prompts to create machine-generated texts, establishing an "Unseen Domains & Unseen Model" scenario.
...
### 📥 How to Get the Data
#### 1. Huggingface
You can access the full dataset, which includes the Cross-domains & Cross-models testbed and two additional wilder test sets, through the Huggingface API (Dataset page: [https://huggingface.co/datasets/yaful/MAGE](https://huggingface.co/datasets/yaful/MAGE)):
```python
