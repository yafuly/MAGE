...
1. source.zip: source texts of human-texts and corresponding texts generated by LLMs, with sources specified as csv file names. For instance, the file "cmv_machine_specified_gpt-3.5-trubo.csv" includes texts from the CMV domain that were generated by the "gpt-3.5-trubo" model using specific prompts. On the other hand, "cmv_human" contains human-written CMV texts.
